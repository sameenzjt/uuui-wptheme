...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'uuui' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'uuui' ),
		'repeat-y'  => __( 'Repeat Vertically', 'uuui' ),
		'repeat'    => __( 'Repeat All', 'uuui' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'uuui' ),
		'top center'    => __( 'Top Center', 'uuui' ),
		'top right'     => __( 'Top Right', 'uuui' ),
		'center left'   => __( 'Middle Left', 'uuui' ),
		'center center' => __( 'Middle Center', 'uuui' ),
		'center right'  => __( 'Middle Right', 'uuui' ),
		'bottom left'   => __( 'Bottom Left', 'uuui' ),
		'bottom center' => __( 'Bottom Center', 'uuui' ),
		'bottom right'  => __( 'Bottom Right', 'uuui')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'uuui' ),
		'fixed'  => __( 'Fixed in Place', 'uuui')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'uuui' ),
		'italic'      => __( 'Italic', 'uuui' ),
		'bold'        => __( 'Bold', 'uuui' ),
		'bold italic' => __( 'Bold Italic', 'uuui' )
		);
